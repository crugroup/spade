...
class TestVariableAPI:
    ...
    def test_update_variable_is_secret_field(self, client, regular_variable, secret_variable):
        ...
        regular_retrieve_url = reverse("variables:retrieve", kwargs={"pk": regular_variable.pk})
        data = {"is_secret": True}
        ...
        secret_retrieve_url = reverse("variables:retrieve", kwargs={"pk": secret_variable.pk})
